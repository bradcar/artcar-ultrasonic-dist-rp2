...
DISP_WIDTH=128
DISP_HEIGHT=64
# Define the number of sensors, more than 3 is redesign
NUMBER_OF_SENSORS = 3
...
flipped_bitmap_sensor_0a_off = bytearray((32 // 8) * 14)
flipped_bitmap_sensor_0a_on =  bytearray((32 // 8) * 14)
flipped_bitmap_sensor_0b_off = bytearray((32 // 8) * 16)
flipped_bitmap_sensor_0b_on =  bytearray((32 // 8) * 16)
flipped_bitmap_sensor_0c_off = bytearray((32 // 8) * 17)
flipped_bitmap_sensor_0c_on =  bytearray((32 // 8) * 17)
flipped_bitmap_sensor_0d_off = bytearray((32 // 8) * 18)
flipped_bitmap_sensor_0d_on =  bytearray((32 // 8) * 18)
# Declare global variables for flipped 2 bitmaps
flipped_bitmap_sensor_1a_off = bytearray((32 // 8) * 9)
flipped_bitmap_sensor_1a_on =  bytearray((32 // 8) * 9)
flipped_bitmap_sensor_1b_off = bytearray((32 // 8) * 10)
flipped_bitmap_sensor_1b_on =  bytearray((32 // 8) * 10)
flipped_bitmap_sensor_1c_off = bytearray((32 // 8) * 10)
flipped_bitmap_sensor_1c_on =  bytearray((32 // 8) * 10)
flipped_bitmap_sensor_1d_off = bytearray((40 // 8) * 10)
flipped_bitmap_sensor_1d_on =  bytearray((40 // 8) * 10)
# Declare global variables for flipped 3 bitmaps
flipped_bitmap_sensor_2a_off = bytearray((32 // 8) * 14)
flipped_bitmap_sensor_2a_on =  bytearray((32 // 8) * 14)
flipped_bitmap_sensor_2b_off = bytearray((32 // 8) * 16)
flipped_bitmap_sensor_2b_on =  bytearray((32 // 8) * 16)
flipped_bitmap_sensor_2c_off = bytearray((32 // 8) * 17)
flipped_bitmap_sensor_2c_on =  bytearray((32 // 8) * 17)
flipped_bitmap_sensor_2d_off = bytearray((32 // 8) * 18)
flipped_bitmap_sensor_2d_on =  bytearray((32 // 8) * 18)
#
...
def ultrasonic_distance_pwm(i, speed, timeout=50000):
    """
    Get ultrasonic distance using an  sensor (you send signal & time) with a timeout.
...
nonworking_sensors = []
for i in range(NUMBER_OF_SENSORS):
    distance = ultrasonic_distance_pwm(i, speed_sound)
